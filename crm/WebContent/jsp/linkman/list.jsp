...
<BODY>
	...
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/linkMan_findAll"
		method=post>
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>联系人名称：</TD>
													<TD>
														<s:textfield theme="simple" cssClass="textbox" cssStyle="WIDTH: 80px" id="sChannel2" maxlength="50" name="lkm_name"/>
													<TD>
													<TD>性別：</TD>
													<TD>
														<s:radio list="#{'1':'男','2':'女'}" name="lkm_gender" theme="simple"/>
													<TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<s:if test="lkm_gender == '2'">女</s:if></TD>
								...
								<TR>
									<TD><div id=pagelink>
											<DIV
												...
												共[<B><s:property value="totalRecordCount"/></B>]条记录,[<B><s:property value="curPage"/></B>]页
												,每页显示
