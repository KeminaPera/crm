...
<script type="text/javascript">
	function registe(){
		window.location.href="${pageContext.request.contextPath}/userAction_registe.action";
	}
</script>
<META content="MSHTML 6.00.6000.16809" name=GENERATOR></HEAD>
<BODY>
<FORM id=form1 name=form1 action="${pageContext.request.contextPath}/userAction_regist.action" method=post>
        ...
        <TR>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              <TBODY>
              <TR>
                <TD style="HEIGHT: 28px" width=80>用户帐号：</TD>
